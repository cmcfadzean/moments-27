...
class MomentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post moments_url, params: { moment: { date: @moment.date, description: @moment.description, title: @moment.title, user_id: @moment.user_id } }
    end
  ...
  test "should update moment" do
    patch moment_url(@moment), params: { moment: { date: @moment.date, description: @moment.description, title: @moment.title, user_id: @moment.user_id } }
